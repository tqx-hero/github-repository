...
# 25 "/usr/include/net/ethernet.h" 3 4
...
# 26 "/usr/include/net/ethernet.h" 2 3 4

# 1 "/usr/include/linux/if_ether.h" 1 3 4
# 25 "/usr/include/linux/if_ether.h" 3 4
...
# 26 "/usr/include/linux/if_ether.h" 2 3 4
# 163 "/usr/include/linux/if_ether.h" 3 4
struct ethhdr {
 unsigned char h_dest[6];
 unsigned char h_source[6];
 __be16 h_proto;
} __attribute__((packed));
# 28 "/usr/include/net/ethernet.h" 2 3 4
...
# 82 "/usr/include/net/ethernet.h" 3 4
...
# 26 "/usr/include/linux/if.h" 2 3 4
# 34 "/usr/include/linux/if.h" 3 4
# 1 "/usr/include/linux/hdlc/ioctl.h" 1 3 4
# 40 "/usr/include/linux/hdlc/ioctl.h" 3 4
typedef struct {
...
# 35 "/usr/include/linux/if.h" 2 3 4
# 79 "/usr/include/linux/if.h" 3 4
...
# 164 "/usr/include/linux/if.h" 3 4
enum {
 IF_OPER_UNKNOWN,
 IF_OPER_NOTPRESENT,
 IF_OPER_DOWN,
...
# 192 "/usr/include/linux/if.h" 3 4
struct ifmap {
...
# 229 "/usr/include/linux/if.h" 3 4
struct ifreq {
...
# 281 "/usr/include/linux/if.h" 3 4
struct ifconf {
 int ifc_len;
 union {
  char *ifcu_buf;
...
# 10 "send_syn.c" 2
# 1 "/usr/include/netpacket/packet.h" 1 3 4
# 22 "/usr/include/netpacket/packet.h" 3 4
struct sockaddr_ll
  {
...
# 68 "/usr/include/netpacket/packet.h" 3 4
struct packet_mreq
  {
    int mr_ifindex;
...
# 58 "send_syn.c"
 ...
 memcpy(message_buf+26,&((struct sockaddr_in*)&req.
# 60 "send_syn.c" 3 4
                                                  ifr_ifru.ifru_addr
# 60 "send_syn.c"
                                                          )->sin_addr.s_addr,4);
 ...
 *(uint16_t*)(message_buf+34) = htons(12000);
 *(uint16_t*)(message_buf+36) = htons(12000);
